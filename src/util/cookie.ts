 ...
 * @param searchUrl 
 */
export async function deleteAll(cookieList: chrome.cookies.SetDetails[], searchUrl: string) {
...
export function cookieToSetDetails(cookies: chrome.cookies.Cookie[], options: {
    url: string,
    storeId: string,
...
export function setDetailsFromCookies(cookies: chrome.cookies.Cookie[], options: {
    url: string,
    storeId: string,
}) {
...
export async function setDetailsByTab(cookies: chrome.cookies.Cookie[], tab: chrome.tabs.Tab) {
